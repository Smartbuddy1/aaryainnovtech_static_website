...
const policySections = [
  ...
  },
  {
    icon: MessageCircle,
    title: "How we use it",
    text: "We use your details only to reply to your enquiry, suggest suitable Aarya Innovtech products, prepare a quotation, coordinate a site discussion, or provide support.",
  },
  {
    icon: ShieldCheck,
    title: "Sharing",
        ...
        <div className="container privacy-page-hero-grid">
          <div className="privacy-page-copy" data-reveal>
            ...
            <p>
              ...
              through the Aarya Innovtech website for hygiene-sector products and public utility solutions.
            </p>
          </div>
      ...
      <section className="privacy-policy-body section">
        <div className="container">
          <div className="section-heading split-heading" data-reveal>
            ...
            <p>
              Product enquiries may relate to Electronic ECO Toilet, Bio-Digester,
              Organic Waste Composter, PET Bottle Shredder / Reverse Vending Machine,
              Computer Kiosk, and Vending Machines.
            </p>
          </div>
